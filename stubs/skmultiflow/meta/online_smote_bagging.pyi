...
def OnlineSMOTEBagging(base_estimator: Any = ..., n_estimators: int = ..., sampling_rate: int = ..., drift_detection: bool = ..., random_state: Optional[Any] = ...): ...
