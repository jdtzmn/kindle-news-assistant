...
from skmultiflow.utils import check_random_state as check_random_state, get_max_value_key as get_max_value_key
...
class AdaSplitNode(SplitNode, AdaNode):
    ...
    def learn_from_instance(self, X: Any, y: Any, weight: Any, hat: Any, parent: Any, parent_branch: Any) -> None: ...
