...
from .externals.cloudpickle import dumps as dumps, loads as loads
...
def get_active_backend(prefer: Optional[Any] = ..., require: Optional[Any] = ..., verbose: int = ...): ...

class parallel_backend:
    old_backend_and_jobs: Any = ...
    new_backend_and_jobs: Any = ...
    def __init__(self, backend: Any, n_jobs: int = ..., inner_max_num_threads: Optional[Any] = ..., **backend_params: Any) -> None: ...
    def __enter__(self): ...
...
class BatchedCalls:
    items: Any = ...
    def __init__(self, iterator_slice: Any, backend_and_jobs: Any, reducer_callback: Optional[Any] = ..., pickle_cache: Optional[Any] = ...) -> None: ...
    def __call__(self): ...
    def __reduce__(self): ...
    def __len__(self): ...

def cpu_count(only_physical_cores: bool = ...): ...
def delayed(function: Any, check_pickle: Optional[Any] = ...): ...

class BatchCompletionCallBack:
    dispatch_timestamp: Any = ...
    batch_size: Any = ...
    parallel: Any = ...
    def __init__(self, dispatch_timestamp: Any, batch_size: Any, parallel: Any) -> None: ...
    def __call__(self, out: Any) -> None: ...

def register_parallel_backend(name: Any, factory: Any, make_default: bool = ...) -> None: ...
...
class Parallel(Logger):
    ...
    pre_dispatch: Any = ...
    batch_size: Any = ...
    def __init__(self, n_jobs: Optional[Any] = ..., backend: Optional[Any] = ..., verbose: int = ..., timeout: Optional[Any] = ..., pre_dispatch: str = ..., batch_size: str = ..., temp_folder: Optional[Any] = ..., max_nbytes: str = ..., mmap_mode: str = ..., prefer: Optional[Any] = ..., require: Optional[Any] = ...) -> None: ...
    def __enter__(self): ...
